...
def main():
    ...
    updated_items = set_center_pos_to_item(source_items, target_item)

    select_if_exists(updated_items)


def set_center_pos_to_item(source_items: Iterable[modo.Mesh], target_item: modo.Item) -> list[modo.Item]:
    updated_items = []
